        ...
        <div className="grid place-items-center grid-flow-row pb-[5%] h-max gap-2"> 
            ...
            className={cn(
                ...
                className="text-2xl md:text-4xl dark:text-white">
                    Hi! I'm <span className={styles["special-text"]}>Francis Mawanda</span> 
                </span>
                </div>

                <div className="grid grid-cols-[max-content_max-content]gap-2">
                    <div 
                    className={cn("pt-2 z-10", styles["bounding-animation"])}
                ...
                <div 
                    className={cn("pt-2 z-[5]", styles["bounding-animation"])}
                 ...
                 <div className=" grid place-items-center grid-flow-row gap-1 pt-10 md:pt-20">
                    <span
                    className={cn( "text-zinc-500 dark:text-zinc-400 !delay-300",
                        styles["fade-in-left"]
                    )}>
                        stuff i'm learning
                    </span>
